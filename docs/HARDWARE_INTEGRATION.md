...
無操作による自動睡眠では、LCDとサーボを睡眠表示・姿勢へ移しつつ、Live WebSocketと連続録音は維持します。話しかけるとその発話を取りこぼさず起床して返答します。「おやすみ」「さよなら」等の明示睡眠だけはLiveと連続録音も停止します。Pi Zero WのバックライトはON/OFF式なので、既定では点灯した睡眠顔を維持し、消灯する場合だけ明示的に0を設定します。明示睡眠から確実に起こす手段はボタンまたはIMUです。
